 ...
 * A seat's stable execution lane is game/<gameId>/seat/<n>; individual turn
 * attempts extend that prefix into isolated context scopes.
 */
...
/** Build the stable agentd lane for one seat. */
